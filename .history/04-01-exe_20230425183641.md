...
#### 3-13 id名とclass名をつけて区別する

  1. articleの枠線の色を３箇所それぞれ変えたいとき
...
#### 3-14 レイアウトを組む
  ...
  1. articleを横並びにする
  2. 横並びにする要素をまとめてグループを作る

```html
    <!-- index.htmlの中 -->
    <!-- articleに親要素divを追加　class名もつけておく -->
    <div class="cat_like">
        <article id="article1">
            <!-- 省略 -->
        </article>
